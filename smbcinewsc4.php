...
<html lang="en">
  ...
  <body>
    ...
    <div> 
      <div class = "textheading">
        <h2 class = "text-center mt-2">3D Printed Tactile Blissymbols</h2>
      </div>  
      <div>
        <img src="https://raw.githubusercontent.com/BlissBCI/BCI/refs/heads/main/assets/Volksswitch.jpg" class="rounded d-block mx-auto" alt="Volksswitch.org" width="400" height="250">
        <div class = "articletext">
          <p class="fs-5 ml-10 mr-10"> <a class="link" href="https://volksswitch.org/index.php/volks-devices/bliss-tactile-symbols/">Volksswitch.org</a> has created a next generation of tactile symbols based on Blissymbolics to teach language to individuals who are blind, deaf-blind, or visually impaired. The symbols may also be effective when used with individuals on the autism spectrum. These Bliss Tactile Symbols are opensource, customizable, extensible, and designed to be 3D-printed.
          </p>
        </div>
      </div>  
    </div>
    <!-- End 3D Printed Tactile Blissymbols -->
