...
<html lang="en">
  ...
  <body>
        ...
        <?php
          if (isset($_GET['error'])) {
              ...
              if ($error == 'incorrect-password') {
                  echo "<div class='adminmessage text-center mt-3'>Incorrect username or password. Please try again.</div>";
              } elseif ($error == 'user-not-found') {
                  echo "<div class='adminmessage text-center mt-3'>Missing credentials or user not found. Please check your details.</div>";
              } elseif ($error == 'db-query-failed') {
                  echo "<div class='adminmessage text-center mt-3'>Database query failed. Please try again later.</div>";
              }
          }
        ?>
        <!-- END PHP -->  
    ...
    <div class="row">
      <div class="col">
        <div class="footer">
          <div class="navbar leftfooter ml-5">
            <h5><a class="text-primary fw-bold nav-link" href="https://conceptography.org/index.html">BCI Home</a></h5>   
