...
<html lang="en">
  ...
  <body>
    ...
    <!-- BCI Admin Log Out -->
    <div> 
      <div class="cardadminlogout">
        <div class="card-body">
          <!-- text in card body -->
          <form action="https://conceptography.org/tmbciadminlogin.php" method="post" class="form">
            <div class="textheading">
              <h2 class="text-center mt-2">BCI Admin</h2>
            </div>
            <div class = "articletext">
              <p class="fs-5 ml-10 mr-10 text-center">You have successfully logged in!</p>
              <p class="fs-5 ml-10 mr-10 text-center">Please request to be added to the<a class="link" href="https://github.com/BlissBCI/BCI">GitHub Repo</a></p>
            </div>  
