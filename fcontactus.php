        ...
        <div class="container">
          <div class="mx-auto">
            <ul class="navbar-nav d-flex flex-row gap-3 text-center">
              ...
              <li class="nav-itemtm">
                <h5><a class="text-center text-primary fw-bold nav-link active" aria-current="page" href="https://conceptography.org/fcontactus.php">Contact BCI</a></h5>
              </li>
              <li class="nav-itemtm">
        ...
        <div class="col">
          <div class="footer">
            <div class="navbar rightfooter flex-column align-items-end ml-0">  
              ...
              <h5><a class="text-primary fw-bold nav-link active" aria-current="page" href="https://conceptography.org/fcontactus.php">Contact BCI</a></h5>
            </div>
          </div>   
        </div>
      </div>
