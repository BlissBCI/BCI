      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary">
          ...
          <div class="container"> 
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-itemtm">
                <h5> <a class="text-center text-primary nav-link" aria-current="page" href="#">BCI Member Log In</a> </h5>
              </li>
              <li class="nav-itemtm">
        ...
        <div class="card-body">
          ...
          <form action="https://conceptography.org/contactmessage.php" method="post"> 
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control border-primary" id="exampleFormControlInput2" placeholder="email@example.com">
            </div>
            <div class="mb-3">
              <label for="exampleFormControlInput2" class="form-label">Subject</label>
              <input type="subject" class="form-control border-primary" id="exampleFormControlInput2" placeholder="Subject">
            </div>
            <div class="mb-3">
              <label for="exampleFormControlTextarea1" class="form-label">Message</label>
              <textarea class="form-control border-primary" id="exampleFormControlTextarea1" placeholder="Write message" rows="3"></textarea>
            </div>
      ...
      <div class="col">
        <div class="footer">
          ...
          <!--<nav class="nav flex-column">-->      
            ...
            <h5> <a class="nav-link text-primary" href="#">BCI Member Log In</a> </h5>
