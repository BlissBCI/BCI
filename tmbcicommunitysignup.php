    ...
    <div> 
      ...
      <form action="https://conceptography.org/communitysignup.php" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="name" class="form-control border-primary" id="name" placeholder="Name">
        </div>
        <div class="mb-3">
          <label for="country" class="form-label fs-5 ml-10 mr-10">Country</label>
          <input type="country" class="form-control border-primary" id="country" placeholder="Country">
        </div>
        <div class="mb-3">
          <label for="emailaddress" class="form-label fs-5 ml-10 mr-10">Email Address</label>
          <input type="emailaddress" class="form-control border-primary" id="emailaddress" placeholder="email@example.com">
        </div>
        <div class="mb-3">
        ...
        <div class="link">
          <p class="fs-5 ml-10 mr-10 text-center">Already a member?<a class="link" aria-current="page" href="">Log In Now!</a></p>
        </div>
      </form>
    </div> 
