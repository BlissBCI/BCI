  ...
  <body>
    ...
    <div class="navsub">
      <ul class="nav justify-content-center">
        ...
        <li class="nav-item">
          <h4><a class="fw-bold nav-link active" href="https://conceptography.org/smbcisupport.php">Support BCI</a></h4>
        </li>
      </ul>
    </div>      
    <!-- End BCI Sub Menu -->
    ...
    <div> 
      <div class = "textheading">
        <h2 class = "text-center mt-2">Support BCI</h2>
      </div>  
      <div>
        <div class = "articletext">
          <p class="fs-4 ml-10 mr-10 text-center">Please consider supporting us<br></p>
          
            <!-- Donate button -->
            <div>
              <div class="btncenter">
                <a class="fs-3 btn btn-primary" href="https://www.paypal.com/ncp/payment/H6Q23BDWPFY8G" role="button">Donate</a>
              </div>
              <div>
              <!-- End Donate button --> 

          <!-- PayPal Logo -->
            <div class= "paypallogo mt-5" >
              <cellpadding="10" cellspacing="0" aligncenter>
                <tr>
                  <td aligncenter></td>
                </tr>
              <tr>
                <td aligncenter>
                  <a href="https://www.paypal.com/webapps/mpp/paypal-popup" title="PayPal logo" onclick="javascript:window.open('https://www.paypal.com/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;"><img src="https://www.paypalobjects.com/webstatic/mktg/logo/AM_mc_vs_dc_ae.jpg" alt="PayPal Acceptance Mark"></a>
                </td>
              </tr>
              </div>
            </div>  
          ...
          <p class="fs-4 ml-10 mr-10 text-center">IBAN (International Account Number):<br>
          SE4480000810599243039279<br>
          BIC (Bank Identifier Code): SWEDSESS<br>
          </p>
          <p class="fs-4 ml-10 mr-10 text-center"><a class="link" href="https://contribee.com/blissymbolicsorg">Donate via Contribee</a>
          </p>  
        </div>
      </div>  
    </div>  
